        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center select-none">
          ...
          <AnimationWrapper variant="fadeRight" delay={0.4}>
            <div className="relative px-3 md:px-6 py-4 text-justify border-l-4 border-blue-500 dark:border-blue-400 rounded bg-white/50 dark:bg-gray-800/50 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                <span className="text-yellow-500 dark:text-yello-400 font-semibold">🥇Gold Medalist | IMCA in Artificial Intelligence</span>
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                I&apos;m passionate about building <span className="text-blue-600 dark:text-blue-400 font-semibold">scalable, user-friendly full-stack solutions </span>
                and integrating <span className="text-purple-600 dark:text-purple-400 font-semibold">AI</span> to enhance efficiency, productivity, and overall application performance.
              </p>

              <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                I continuously upskill by exploring new technologies to refine my expertise and deliver impactful, future-ready solutions.
              </p>
              ...
              {timelineItems.map((item, index) => (
                ...
                >
                  <div className="flex items-center justify-center">
                    <div className={`w-10 h-10 rounded-full z-10 flex items-center justify-center ${item.type === "education" ? "bg-gradient-to-br from-blue-500 to-blue-700 dark:from-blue-400 dark:to-blue-600" : "bg-gradient-to-br from-purple-500 to-purple-700 dark:from-purple-400 dark:to-purple-600"
                      } shadow-md transition-transform duration-300 hover:scale-110`}>
                      <FaUserGraduate className="text-white" size={16} />
                    </div>
                  </div>

                  <div className={`absolute top-0 ${index % 2 === 0 ? "right-1/2 pr-12" : "left-1/2 pl-12"
                    } mt-0`}>
                    <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border-b-4 border-blue-500 dark:border-blue-400">
                      <span className={`text-sm font-semibold px-3 py-1 rounded-full ${item.type === "education" ? "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300" :
          ...
          <div className="md:hidden">
            <div className="relative space-y-8 pb-4">
              ...
              {timelineItems.map((item, index) => (
                ...
                >
                  <div className={`absolute left-0 transform -translate-x-1/2 flex items-center justify-center w-10 h-10 rounded-full z-10 shadow-md ${item.type === "education" ? "bg-gradient-to-br from-blue-500 to-blue-700 dark:from-blue-400 dark:to-blue-600" : "bg-gradient-to-br from-purple-500 to-purple-700 dark:from-purple-400 dark:to-purple-600"
